...
export class DonneesFestival {
    ...
    set dateDebut(dateDebut: Date) {
        if (!this.checkDateDebutFin()) throw new Error('La date de début doit être avant la date de fin');
    ...
    public async createDefaultCreneaux() {
        ...
        for (let i = 0; i < nbJours; i++) {
            ...
            this.joursCreneaux.push(new Jour(date, []));
        }


        // remplir les créneaux par jour par les jours
        this.joursCreneaux.forEach(jour => {
    ...
    private checkDateDebutFin(): boolean {
